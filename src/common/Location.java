...
/**
 * A common.Location is a point in a 2D coordinate system, with increasing x from west
 ...
 * coordinate has its direction flipped from common.Location objects.
 * 
 * Methods are provided to convert between these two coordinate systems, but
 * this conversion requires an origin common.Location (a common.Location at the origin will be
 ...
 * coordinate system used in the input files and into the common.Location coordinate
 * system.
 */
...
public class Location {
	...
	/**
	 * Makes a new Point object from this common.Location object and returns it. To
	...
	/**
	 * Create a new common.Location object from a given Point object, as well as the
	...
	/**
	 * Create a new common.Location object from the given latitude and longitude, which
	...
	// ------------------------------------------
	// some utility methods for common.Location objects
	// ------------------------------------------

	/**
	 * Returns a new common.Location object that is this common.Location object moved by the
	 * given dx and dy, ie. this returns a common.Location representing (x + dx, y +
	 * dy).
	 */
